...
const validation = zod.object({
    ...
    role_id : zod.number().nonnegative({message : "El role tiene que ser un id"}),
    user_status : zod.boolean({message : "El status tiene que ser un booleano"}).default(true),
    created_at : zod.date({message : "Tiene que ser un dato de tipo date"}).default(() => new Date()),
